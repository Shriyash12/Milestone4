 ...
 * 
 * import MS4.POM.testCaseOnePOM; import MS4.POM.testCaseThreePOM; import
 * MS4.POM.testCaseTwoPOM; import MS4.base.BaseClass; import
 ...
 * Throwable { objOne.getName().click(); }
 * 
 ...
 * String Details= objOne.getClicked().getText(); System.out.println(Details); }
 * 
 * @And("^Open the website$") public void open_the_website() throws Throwable {
 * driver.get(prop.getProperty("url")); }
 * 
 * @And("^under Shop Product select powder from dropdown$") public void
 ...
 * 
 * // Step definition of 2nd testCaseTwoPOM objTwo = new testCaseTwoPOM(driver);
 * 
 ...
 * 
 * // step Definition of 3rd testCaseThreePOM objThree = new
 * testCaseThreePOM(driver);
 * 
