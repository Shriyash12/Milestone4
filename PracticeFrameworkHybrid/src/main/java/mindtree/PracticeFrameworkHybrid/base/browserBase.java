package mindtree.PracticeFrameworkHybrid.base;
	...
	public WebDriver initializeBrowser() {
		try {
			...
			FileInputStream fis = new FileInputStream(
					"C:\\Users\\M1073173\\SeleniumStuff\\PracticeFrameworkHybrid\\src\\resources\\prop.properties");
	...
	public void getScreenshot(String result) {
		try {
			...
			FileUtils.copyFile(src, new File(
					"C:\\Users\\M1073173\\SeleniumStuff\\PracticeFrameworkHybrid\\Screenshot\\screenshot.png"));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
